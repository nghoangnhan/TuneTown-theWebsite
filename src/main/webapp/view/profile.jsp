...
<%--  <!-- WRAP FORM  -->--%>
<%--&lt;%&ndash;  <form action="modifyProfile" method="post" enctype="multipart/form-data">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div class="updateInfor-form">&ndash;%&gt;--%>
<%--&lt;%&ndash;      <div class="wrapper">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="title">Update Informations</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="form">&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield image">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div id="wrapper-image-input">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <img id="image-preview"  src="${user.getUserAvatar()}" onclick="updateAvatar()"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <input id="image-input" type="file" name="userAvatar" accept="image/*" class="" />&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Username</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input value="${user.getUserName()}" name="username" type="text" class="input" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Password</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input value="${user.getUserPassword()}" name="password" type="password" class="input" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Birthday</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input value="${user.getBirthDate()}" name="birthdate" type="date" class="input" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Gender</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="custom_select">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <select name="gender">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <option value="0">Male</option>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <option value="1">Female</option>&ndash;%&gt;--%>
<%--&lt;%&ndash;              </select>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Email Address</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input value="${user.getEmail()}" name="email" type="text" class="input" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <label>Bio</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input value="${user.getUserBio()}" name="userBio" class="textarea" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="inputfield">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <input type="submit" value="Update" class="btn" />&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;      </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
